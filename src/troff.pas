...
Procedure OutputTroff(Var F:System.Text; Const Desc:TPageDescription; Const FileName:AnsiString);

Function ParseTroff(Troff:AnsiString; Out Desc:TPageDescription):sInt;
